$(function () {
        ...
        if (windowWidth > 0) {
            ...
            if ($(document).scrollTop() >= 100) {
                ...
                if ($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    ...
                    $('.logo img').attr('src', 'https://oryon-imobiliare.ro/wp-content/uploads/2018/02/1-1.png');
    ...
    $(document).ready(function ($) {
        ...
        window.setTimeout(start_slick, 1000);
	...
	// Card's slider
	  ...
	  $carousel
		...
		.magnificPopup({
		  ...
		  tLoading: 'Đ—Đ°ĐłŃ€ŃĐ·ĐşĐ°...',
		  mainClass: 'mfp-zoom-in mfp-img-mobile',
		  image: {
			verticalFit: true,
			tError: '<a href="%url%">Đ¤ĐľŃ‚Đľ #%curr%</a> Đ˝Đµ Đ·Đ°ĐłŃ€ŃĐ·Đ¸Đ»ĐľŃŃŚ.'
		  },
		  gallery: {
			enabled: true,
			navigateByImgClick: true,
			tCounter: '<span class="mfp-counter">%curr% Đ¸Đ· %total%</span>', // markup of counte
