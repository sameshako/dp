            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                ...
                <div class="property_block_wrap style-2 p-4">
                    <div class="prt-detail-title-desc">
                        ...
                        <h3 class="prt-price-fix"><?php echo e($property->pret); ?>€</h3>
                ...
                <div class="property_block_wrap style-2">
                    ...
                    <div id="clTwo" class="panel-collapse collapse show">
                        <div class="block-body">
                                <p><?php echo e($property->description); ?>
                    ...
                    <div id="clThree" class="panel-collapse collapse show">
                        <div class="block-body">
                            <ul class="avl-features third color">
                                <?php if($property->dotari!=null): ?>
                                <?php $array=json_decode($property->dotari) ?>
                                <?php $__currentLoopData = $array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $elem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($elem); ?></li>
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/getbrand/dp.getbrandedwork.ro/resources/views/properties/show-one.blade.php ENDPATH**/ ?>