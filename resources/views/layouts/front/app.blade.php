...
<body>
    ...
    @include('layouts.front.home-app')
                    ...
                    <div class="footer-item">
                        ...
                        <ul class="links">
                            ...
                            <li>
                                ...
                                <a href="{{--route('despre')--}}"><i class="fa fa-angle-right"></i>Despre noi</a>
                            ...
                            <li>
                                ...
                                <a href="{{--route('contact')--}}"><i class="fa fa-angle-right"></i>Cariere</a>

                            </li>

                            <li>

                                <a href="{{--route('termeni-si-conditii')--}}"><i class="fa fa-angle-right"></i>Termeni si Conditii</a>
                        ...
                        <div class="imob-property-wrapper">
                            <div class="row">
                                {{--@foreach($propertyTypes as $propertyType)
                                    <div class="col-lg-4">
                                        <div class="imob-property-type-wrapper btn btn-light w-100">
                                            <a class="imob-property-link w-100 h-100"
                                                href="{{ route('properties.create', $propertyType->slug) }}">
                                <input type="radio" name="imob-property-radio" id="option1" autocomplete="off">
                                <i class="{{ $propertyType->icon }}"></i>
                                <div class="property-type-title">{{ $propertyType->name }}</div>
                                </a>
                            </div>
                        </div>
                        @endforeach--}}
